...
var _index = _interopRequireDefault(__webpack_require__(/*! ./sub_tim/pages/joinUs/index.vue */ 403));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_2bf1dc1f_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=2bf1dc1f&scoped=true& */ 404);
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_2bf1dc1f_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=2bf1dc1f&lang=scss&scoped=true& */ 408);
      ...
      this.judgeFun().then(function () {
        ...
        if (_this.type === 1) {
          ...
          params = {
            ...
            'content[contact_name]': _this.name,
            'content[contact_phone]': _this.contact_phone,
            'content[referrer_phone]': _this.recommentdPhone,
            'content[code]': _this.inviteCode };
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this2.type === 1) {
          ...
          if (!_this2.name) {
            ...
            tip = '请填写正确的联系电话';
            reject();
          } else if (!(0, _utils.regExp)('mobile', _this2.recommentdPhone)) {
            tip = '请填写正确的推荐人电话';
            reject();
          } else {
            resolve();
