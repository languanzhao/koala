...
var _store = _interopRequireDefault(__webpack_require__(/*! @/vuex/store.js */ 13));
var _main = _interopRequireDefault(__webpack_require__(/*! @/main.js */ 0));
var _utils = __webpack_require__(/*! @/common/utils.js */ 16);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 对uni.request二次封装
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.unReadCount_news = unReadCount_news;exports.app_share_wx = app_share_wx;exports.hideMenuItems = hideMenuItems;exports.schoolDetailShare = schoolDetailShare;exports.login_mp_wx = login_mp_wx;exports.login_wx_h5 = login_wx_h5;exports.set_user_info = set_user_info;exports.removeHTMLTag = removeHTMLTag;exports.schoolInfoToLink = schoolInfoToLink;exports.canvasText = canvasText;exports.getLocationSearchParams = getLocationSearchParams;exports.schoolType = schoolType;exports.isTokenExpired = isTokenExpired;exports.uploadImage = uploadImage;exports.debounce = debounce;exports.Throttle = Throttle;exports.goLogin = goLogin;exports.checkLogin = checkLogin;exports.copyValue = copyValue;exports.regExp = regExp;exports.getWindowResize = getWindowResize;exports.checkAuthSetting = checkAuthSetting;exports.default = void 0;var _store = _interopRequireDefault(__webpack_require__(/*! @/vuex/store */ 13));
var _main = _interopRequireDefault(__webpack_require__(/*! @/main.js */ 0));
...
function app_share_wx(type, schoolItem) {
  ...
  var shareUrl = _main.default.$projectUrl + 'h6/#/sub_school/pages/detail/index?id=' + schoolItem.id;
  if (koala && koala.code) {
...
//微信小程序登录
function login_mp_wx(paramsCode) {
  var that = _main.default;
  if (_store.default.state.userInfo.id) {
    //用户登录了
    that.$http({
...
function login_wx_h5(type, paramsCode) {
  var that = _main.default;
...
function set_user_info(data, type, paramsCode) {
  ...
  that.$http({
    ...
    method: 'GET' }).
  then(function (res) {
    that.$store.commit('setUserInfo', res.data);var _res$data$koala3 =
    res.data.koala,is_counselor = _res$data$koala3.is_counselor,is_registration = _res$data$koala3.is_registration,parent_id = _res$data$koala3.parent_id;
    var codeParam = '';
    if (type == 1) {
      codeParam = getLocationSearchParams().invitedCode;
    } else if (type == 2) {
...
var _mixin = _interopRequireDefault(__webpack_require__(/*! @/uview/libs/mixin/mixin.js */ 19));


var _request = _interopRequireDefault(__webpack_require__(/*! @/uview/libs/request */ 20));
...
var _queryParams = __webpack_require__(/*! @/uview/libs/function/queryParams.js */ 24);



var _route = __webpack_require__(/*! @/uview/libs/function/route.js */ 25);



var _timeFormat = __webpack_require__(/*! @/uview/libs/function/timeFormat.js */ 26);



var _timeFrom = __webpack_require__(/*! @/uview/libs/function/timeFrom.js */ 27);



var _colorGradient = __webpack_require__(/*! @/uview/libs/function/colorGradient.js */ 28);





var _guid = __webpack_require__(/*! @/uview/libs/function/guid.js */ 29);



var _color = __webpack_require__(/*! @/uview/libs/function/color.js */ 30);



var _type2icon = __webpack_require__(/*! @/uview/libs/function/type2icon.js */ 31);



var _randomArray = __webpack_require__(/*! @/uview/libs/function/randomArray.js */ 32);




var _test = _interopRequireDefault(__webpack_require__(/*! @/uview/libs/function/test.js */ 33));

var _random = __webpack_require__(/*! @/uview/libs/function/random.js */ 34);



var _trim = __webpack_require__(/*! @/uview/libs/function/trim.js */ 35);



var _toast = __webpack_require__(/*! @/uview/libs/function/toast.js */ 36);




var _config = _interopRequireDefault(__webpack_require__(/*! @/uview/libs/config/config.js */ 37));

var _zIndex = _interopRequireDefault(__webpack_require__(/*! @/uview/libs/config/zIndex.js */ 38));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 引入全局mixin
// 全局挂载引入http相关请求拦截插件
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _queryParams = __webpack_require__(/*! @/uview/libs/function/queryParams.js */ 24);
/**
                                                                                  * 路由跳转
