...
var _index = _interopRequireDefault(__webpack_require__(/*! ./sub_adviser/pages/team/index.vue */ 489));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_vue_vue_type_template_id_8f2ddbbc_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=8f2ddbbc&scoped=true& */ 490);
...
/* harmony import */ var _index_vue_vue_type_style_index_1_id_8f2ddbbc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=1&id=8f2ddbbc&lang=scss&scoped=true& */ 496);
...
var _utils = __webpack_require__(/*! @/common/utils.js */ 16);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var roleAdviser = function roleAdviser() {__webpack_require__.e(/*! require.ensure | pages/user/components/role-adviser */ "pages/user/components/role-adviser").then((function () {return resolve(__webpack_require__(/*! @/pages/user/components/role-adviser.vue */ 533));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default =
{
  ...
  methods: {
    ...
    //获取对应数据
    getDataList: function getDataList(apiUrl) {var _this2 = this;
      if (!apiUrl) {
        apiUrl = _api.default.invitees;
      }
      var list = this.list || [];
      ...
      then(function (res) {
        ...
        _this2.current_page = res.meta.current_page;
      }).catch(function (err) {
      });
    },
    //复制
