<template>
	<view class="apply">
		...
		<view class="userInfo module" @click="editInfo">
			<view class="module-left" v-if="information.phone && information.koala.name && information.koala.graduation && information.koala.contact_province">
			...
			<view class="" v-else>去完善个人报考信息</view>
	...
	export default{
		...
		methods:{
			...
			applicationClick(){
				...
				if(information.phone && information.koala.name && information.koala.graduation && information.koala.contact_province){
