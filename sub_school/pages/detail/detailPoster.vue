...
<script>
	...
	export default{
		...
		methods:{
				...
				return new Promise((resolve,reject) => {
					...
					this.$http({
						...
						if(data.length > 0){
							...
							this.shareImgList = [this.$projectUrl + 'koala_images/poster/02.png',this.$projectUrl + 'koala_images/poster/01.png',this.$projectUrl + 'koala_images/poster/03.png']
			...
			//生成学校详情二维码
			make() {
				let url = this.$projectUrl + 'h6/#/sub_school/pages/detail/index?id=' + this.schoolInfo.id
				if(this.userInfo.koala.code){
