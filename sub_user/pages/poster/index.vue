				...
				this.$http({
					...
					uni.getImageInfo({
						...
						success:path => {
							...
							this.myCanvasOne('myCanvasTwo',this.$projectUrl + 'koala_images/poster/two.jpg')
							this.myCanvasOne('myCanvasOne',this.$projectUrl + 'koala_images/poster/one.jpg')
							this.myCanvasOne('myCanvasThree',this.$projectUrl + 'koala_images/poster/three.jpg')
						}
					})
				}).catch(err => {
