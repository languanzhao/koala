	...
	<view class="wallet">
		<view class="content">
			<view class="sum">
				...
				<view class="summary" @click="summaryClick(true)">
					累计在途说明<text class="iconfont icon-yiwen"></text>
				</view>
			</view>
			<view class="account-num">
				...
				<view class="item withdraw">
					...
					<view class="money">{{info.koala.withdraw}}</view>
				</view>
			</view>
			<view class="bonus">
				...
				<view class="item">
					<view class="word" @click="summaryClick(false)">团队差旅补助<text class="iconfont icon-yiwen"></text></view>
					<view class="estimation">估算中...</view>
				</view>
			</view>
			<view class="total">
				当前可提现<text class="num">{{info.koala.amount}}</text>
			</view>
		</view>
		...
		<uni-popup ref='uniPopup'>
			<view class="uniPopup-toast">
				...
				<view class="uniPopup-summary">2、若被邀请人取消报名、申请退学，则无法进行提现或须退还相应补助。</view>
				<view class="uniPopup-summary">3、每月的15日后可提现上月发放的差旅补助。</view>
