	...
	<view class="IDAuth">
		...
		<view class="header">
			...
			<view class="item">
				...
				<input class='input' type="text" :disabled="userInfo.koala.id_no" v-model="id_no" placeholder="请输入身份证号码" v-if="!userInfo.koala.id_no"/>
				<view class="input" v-else>{{id_no | hideMiddle}}</view>
			</view>
		</view>
