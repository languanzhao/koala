...
<script>
	...
	export default{
		...
		data(){
			return {
				iconAvatar:this.$projectUrl + 'koala_images/img/icon_avatar.png',
				iconSboy:this.$projectUrl + 'koala_images/img/icon_Sboy.png',
				iconGirl:this.$projectUrl + 'koala_images/img/icon_girl.png',
				iconBoy:this.$projectUrl + 'koala_images/img/icon_boy.png',
				iconSgirl:this.$projectUrl + 'koala_images/img/icon_Sgirl.png',
				active:null,
				current:2,
				items: [{
						value: 'USA',
