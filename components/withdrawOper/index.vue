<template>
	<view class="">
		...
		<uni-popup ref='popup'>
			<view class="popupContent">
				...
				<view class="oper">
					...
					<view class="item confirm" @click="withdrawClick">确定</view>
				</view>
		...
		<uni-popup ref='tipPopup'>
			<view class="tipPopup">
				<view class="title">提现申请</view>
				<view class="summary">点击一键复制，向考拉上学财务客服人员发送：“我要提现！”的指令，即可很快到账</view>
				<view class="wxNumber" @click="copy">{{wxNumber}}</view>
				<view class="oper">
					<view @click="cancelBtn(2)">打开微信立即提现</view>
					<view class="btn" @click="cancelBtn(2)">打开微信</view>
				</view>
